...
# Defines the scene
SCENE = [SpherePhongEx((1,1,12), 4, DARK, (0.8,0.8,0.8),0.8),SpherePhongEx((1.5,-2,4), 1, BLUE, (0.9,0.9,0.4),0),SpherePhongEx((3.5,-2.8,4), 0.2, YELLOW, (0.9,0.9,0.4),0.05),SpherePhongEx((-5.5,-2.2,8), 0.8, GREEN, (0.9,0.9,0.4),0.5),PlanePhongEx((0,1,0),3,BROWN,(0.9,0.9,0.0),0.5)]
AMBIENT = 0.1
